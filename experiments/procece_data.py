        ...
        try:
            ...
            if isinstance(config["c_alpha"][0], list):
                ...
                dir_weights = (
                    ...
                    else np.ones(n_dir_components) / n_dir_components
                )
                evaluator = metrics.MixtureDirichletGaussianWishartEvaluator(
                    n_components
                )
                results = []
            ...
            def dict_to_xarray_direct(data_list):
                ...
                var_names = [
                    ...
                    "variance_mahalanobis",
                    "expected_overlap",
                    "variance_overlap",
                    "model_complexity",
                    "separation_confidence_interval",
                ]
                ...
                for var in var_names:
                    ...
                    if var in [
                        ...
                        data_vars[var] = (
                            ["simulation", "component1", "component2"],
                            values,
                        )
